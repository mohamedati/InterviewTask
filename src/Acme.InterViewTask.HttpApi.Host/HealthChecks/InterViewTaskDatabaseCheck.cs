...
public class InterViewTaskDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InterViewTaskDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
