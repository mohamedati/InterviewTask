...
namespace Acme.InterViewTask.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAddDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartID = table.Column<int>(type: "int", maxLength: 128, nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "AbpUsers",
                columns: new[] { "Id", "CartID", "ConcurrencyStamp", "CreationTime", "CreatorId", "DeleterId", "DeletionTime", "Email", "EntityVersion", "ExtraProperties", "IsActive", "LastModificationTime", "LastModifierId", "LastPasswordChangeTime", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "SecurityStamp", "ShouldChangePasswordOnNextLogin", "Surname", "TenantId", "UserName" },
                values: new object[] { new Guid("3ec9a8c8-6995-4d6e-b9a3-dad5bab7456e"), null, "9c1b9681f56b4a168e30a7de18c91d57", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "atiffahmykhamis@gmail.com", 0, "{}", true, null, null, null, null, null, "ATIFFAHMYKHAMIS@GMAIL.COM", "MOHAMEDATIF", null, null, "2be6f526-72cb-4a43-98ac-4804704ce8b5", false, null, null, "MohamedAtif" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "Name", "Price", "QuantityInStock", "Title" },
                values: new object[,]
                {
                    { 5, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 6, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 7, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 8, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 9, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 10, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 11, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 12, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 13, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 14, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 15, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 16, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 17, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" },
                    { 18, "Dell LapTop inspiron", "Dell LapTop", 1500m, 10, "LapTop" }
                });
